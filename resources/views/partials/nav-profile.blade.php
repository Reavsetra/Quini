...
<div class="columns medium-3 user-menu">
    <ul>
        ...
        <li><a href="{{ route('combinacion.create', auth()->user()->nombre_usuario) }}"><i class="fa fa-futbol-o"></i> Jugar</a></li>
        <li><a href="{{ route('combinacion.index', auth()->user()->nombre_usuario) }}"><i class="fa fa-list-alt"></i> Historial de Juegos</a></li>
